      ...
      <form @submit.prevent="onSubmit">
        ...
        <div class="input" :class="{invalid: $v.password.$error}">
          ...
          <input
                  ...
                  v-model="password">
          <p v-if="!$v.password.minLen">Password has to be at least 6 charactors</p>
        </div>
        ...
        <p v-if="!$v.confirmPassword.sameAs">Password has to be the same</p>
        <div class="input">
...
//        sameAs: sameAs('password')
    ...
    methods: {
      ...
      onSubmit () {
        ...
        // vuex handle down below
        this.$store.dispatch('signup', {email: formData.email, password: formData.password})
//        axios.post('/signupNewUser?key=AIzaSyD7tPv885GAGMAk-ZQbWp9_kfr7_SpQ3Rk', {
